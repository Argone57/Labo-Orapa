...
const APP_VERSION = (()=>{
  try{
    return new URL(document.currentScript?.src || '',window.location.href).searchParams.get('v') || '20260901-0005';
  }catch(_error){
    return '20260901-0005';
  }
})();
