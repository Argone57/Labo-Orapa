...
const APP_VERSION = (()=>{
  try{
    return new URL(document.currentScript?.src || '',window.location.href).searchParams.get('v') || '20260831-0007';
  }catch(_error){
    return '20260831-0007';
  }
})();
...
function setRankingView(view){
  ...
  $('#rankingConfigSelect').style.display=(view==='solo'&&historyDisplayMode!=='classic')?'none':'';
...
async function renderSpaceHistoryRanking(){
